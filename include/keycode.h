...
// Modifier bitmasks
#define OSX_MODIFIER_CAPSLOCK   (1 << 16)
#define OSX_MODIFIER_SHIFT      (1 << 17)
#define OSX_MODIFIER_CONTROL    (1 << 18)
#define OSX_MODIFIER_OPTION     (1 << 19)
#define OSX_MODIFIER_COMMAND    (1 << 20)
